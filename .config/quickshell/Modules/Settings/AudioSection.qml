...
Component {
    ...
    ColumnLayout {
        ...
        Text { text: "Output"; font.pixelSize: 14; font.bold: true; color: Theme.color_a_text; Layout.leftMargin: 20 }
        Rectangle {
            id: outputCard
            Layout.fillWidth: true
            Layout.leftMargin: 15; Layout.rightMargin: 15
            color: Theme.color_2; radius: 5; clip: true
            implicitHeight: outputCol.height + 16
            ColumnLayout {
                id: outputCol
                ...
                Repeater {
                    ...
                    Rectangle {
                        ...
                        color: maOut.containsMouse ? Theme.color_3 : Theme.color_1_solid
                        ...
                        RowLayout {
                            ...
                            Text {
                                ...
                                font.pixelSize: 12; color: Theme.text_color; Layout.fillWidth: true
                            }
                            Text {
                        ...
                        MouseArea {
                            id: maOut; anchors.fill: parent; hoverEnabled: true; cursorShape: Qt.PointingHandCursor
        ...
        Text { text: "Input"; font.pixelSize: 14; font.bold: true; color: Theme.color_a_text; Layout.leftMargin: 20 }
        Rectangle {
            id: inputCard
            Layout.fillWidth: true
            Layout.leftMargin: 15; Layout.rightMargin: 15
            color: Theme.color_2; radius: 5; clip: true
            implicitHeight: inputCol.height + 16
            ColumnLayout {
                id: inputCol
                anchors.top: parent.top; anchors.left: parent.left; anchors.right: parent.right
                anchors.margins: 8; spacing: 6
                Repeater {
                    ...
                    Rectangle {
                        Layout.fillWidth: true
                        Layout.preferredHeight: 40
                        color: maIn.containsMouse ? Theme.color_3 : Theme.color_1_solid
                        Behavior on color { ColorAnimation { duration: 250 } }
                        border.width: modelData.isDefault ? 1 : 0
                        border.color: Theme.color_a_text
                        radius: 8
                        ...
                        MouseArea {
                            id: maIn; anchors.fill: parent; hoverEnabled: true; cursorShape: Qt.PointingHandCursor
                ...
                Slider {
                    ...
                    background: Rectangle {
                        ...
                        Rectangle {
                            ...
                            height: parent.height; color: Theme.color_g; radius: 3
                        }
                    }
                    handle: Rectangle {
