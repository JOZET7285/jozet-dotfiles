...
Item {
    ...
    Component {
        ...
        Item {
            ...
            ParallelAnimation {
                id: openAnim
                YAnimator { target: container; from: container.y; to: 0; duration: 220; easing.type: Easing.OutCubic }
                onStopped: bluetoothPopup.animating = false
            }

            ParallelAnimation {
                id: closeAnim
                
                YAnimator { target: container; from: 0; to: -content.y; duration: 220; easing.type: Easing.OutCubic }
                onStopped: {
                    bluetoothPopup.animating = false
